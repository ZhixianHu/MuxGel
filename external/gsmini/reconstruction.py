# Modified and adapted from gsrobotics https://github.com/gelsightinc/gsrobotics
...
class Reconstruction3D:
    ...
    def load_nn(self, net_path: str) -> Optional[torch.nn.Module]:
        ...
        if not os.path.isfile(net_path):
            print(f"Error opening {net_path}. Path does not exist.")
            return None
    ...
    def get_depthmap(
        ...
        if self.depth_map_zero_counter < 50:
            ...
            if self.depth_map_zero_counter == 0:
                print("Zeroing depth. Please do not touch the sensor...")
