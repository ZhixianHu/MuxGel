...
class DualResNet34UNet(nn.Module):
    def __init__(self, n_channels=3, n_classes_tact=3, n_classes_vis=3):
        ...
        self.tact_final_act = nn.Sigmoid()
...
class DecouplingLoss(nn.Module):
    ...
    def forward(self, tact_pred, tact_gt, vis_pred, vis_gt):
        ...
        loss_tact_perc = self.perceptual(tact_pred, tact_gt)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for batch in pbar:
            ...
            with torch.cuda.amp.autocast():
                ...
                loss, loss_dict = criterion(tact_pred, tact_gt, vis_pred, rgb_gt)
            ...
            if run is not None and (pbar.n % args.log_interval == 0):
                with torch.no_grad():
                    ...
                    wandb.log({"preview": wandb.Image(grid, caption="fused | tact_gt_recon | rgb_gt | tact_pred | vis_pred")}, step=global_step)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sim_ckpt', type=str, default='/home/zhixian/code/MuxGel/outputs/muxgel/sim_si_run/best_checkpoint.pth')
    parser.add_argument('--ckpt', type=str, default='')
    # parser.add_argument('--eval_out', type=str, default='./recon_imgs')
    parser.add_argument('--run_name', type=str, default='real_si_run')
