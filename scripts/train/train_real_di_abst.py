...
if __name__ == "__main__":
    ...
    parser.add_argument('--sim_ckpt', type=str, default='/home/zhixian/code/MuxGel/outputs/muxgel/sim_di_abst_run/best_checkpoint.pth')
    parser.add_argument('--ckpt', type=str, default='')
    # parser.add_argument('--eval_out', type=str, default='./recon_imgs')
    parser.add_argument('--run_name', type=str, default='real_di_abst_run')
